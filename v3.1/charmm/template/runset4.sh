...
# Run the simulation
mpirun -np $(($nreps * $nnodes)) -x OMP_NUM_THREADS=4 --bind-to none --bynode $CHARMMEXEC nsteps=500000 nsavc=10000 seed=$RANDOM itt=$itt -i ../msld_prod.inp > output_$itt 2> error_$itt
